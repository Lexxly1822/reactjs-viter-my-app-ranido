...
$header->header_name = checkIndex($data, 'header_name'); // call the header name galing sa data
$header->header_link = checkIndex($data, 'header_link'); // call the header name galing sa data
