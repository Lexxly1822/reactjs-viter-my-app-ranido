    ...
    <>
      ...
      >
        ...
        >
          <IndentDecrease
            onClick={toggleSideNav}
            className={`text-dashboard h-[18px] w-[18px]
        group:hover:text-white transition-all ease-in-out duration-300 cursor-pointer ${
        ...
        <ul className="py-5">
          <li className="mb-3">
            <div className="py-1 flex items-center justify-between gap-2 hover:bg-primary transition-all ease-in-out duration-200 cursor-pointer">
